...
void slider_moved_callback(const std_msgs::Bool::ConstPtr& slider_moved_in) {
	...
	slider.moved_changed = true;
}

// void init_pos_callback(const std_msgs::UInt16::ConstPtr& slider_moved_in) {
...
int main(int argc, char** argv){
	...
	systemStates systemState = MANUAL_FREEROLL;
	systemStates nextState = MANUAL_FREEROLL;
	phone.cmd = CANCEL_NAV;
