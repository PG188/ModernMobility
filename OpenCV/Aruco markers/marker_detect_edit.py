...
# seperate it from closest, and estimate its pose using 
...
_, image_color = cap.read() #get the video frame

#Read in color image, 'image_color', here
try:
    image_gray = cv2.cvtColor(image_color, cv2.COLOR_BGR2GRAY)
    corners, ids, rejectedImgPoints = aruco.detectMarkers(image_gray, aruco_dict, calibrationParams)
