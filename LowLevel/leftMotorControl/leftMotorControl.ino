...
//float filterFrequency_PID = 0.8;
//FilterOnePole PID_output(LOWPASS, filterFrequency_PID);
...
void loop() {  
  ...
  //Serial.print(wheelVel);Serial.print(",");
  ...
  //PID_output.input(Output);
  //MotorCmd = PID_output.output();
  MotorCmd = 0;
